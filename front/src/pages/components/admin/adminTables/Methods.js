  ...
  return (
    <Datagrid rowClick="edit">
      {Object.entries(fields).map(([key, value], y) => {
        ...
        if (value.typeof === "boolean_")
          return <BooleanField source={value.field} />;
        if (value.typeof === "date") return <DateField source={value.field} />;
        if (value.typeof === "integer")
          return <NumberField source={value.field} />;
        if (value.typeof === "string") {
          if (value?.comment?.includes("email"))
            return <EmailField source={value.field} />;
          if (value?.comment?.includes("file"))
            return <FileField source={value.field} title="title" />;
          if (value?.comment?.includes("image"))
            return <ImageField url={value.field} />;
          if (value?.comment?.includes("url_"))
            return <UrlField source={value.field} />;
...
export const Listing =
  ({ table, fields, structure, line }) => (props) =>
  (<List {...props}>
    <DataGriCustom
      table={table}
      fields={fields}
        ...
        <Component {...props}>
          <SimpleForm>
            {Object.entries(fields).map(([key, value], y) => {
              ...
              if (value?.typeof === "boolean_")
                return <BooleanInput source={value.field} />;
              if (value?.typeof === "date")
                return <DateInput source={value.field} />;
              if (value?.typeof === "integer")
                return <NumberInput source={value.field} />;
              // if (value?.typeof === "string") {
              //   if (value?.comment?.includes("email"))
